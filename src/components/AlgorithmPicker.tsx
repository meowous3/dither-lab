...
const ALGORITHMS: { id: DitherAlgorithm; label: string; desc: string }[] = [
  ...
  { id: 'halftone',            label: 'Halftone',             desc: 'Circular dot pattern' },
  { id: 'crosshatch',          label: 'Crosshatch',           desc: 'Diagonal crossing lines' },
  { id: 'horizontal-line',     label: 'Lines',                desc: 'Horizontal line pattern' },
